...
filename: machine_learning.markdown
...
Here is a list of my current and former projects with a focus on machine learning.
...
flowchart LR
    ...
    class SimpleDataset,PaMpeR highlighted;
