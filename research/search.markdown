...
layout: default
title: "Search"
filename: search.markdown
permalink: /research/search/
---
...
Here is a list of my current and former projects with a focus on Search.
...
flowchart LR
    ...
    class PSL,GoalOriented,TemplateBased,Abduction,GeneticSyn,SmarterInduct highlighted;
