...
layout: default
title: "Conjecturing"
filename: conjecturing.markdown
permalink: /research/conjecturing/
---
...
Here is a list of my current and former projects with a focus on conjecturing.
...
flowchart LR
    ...
    class GoalOriented,TemplateBased,Abduction highlighted;
