...
- **Previously Accepted / Published Work**: For papers already accepted or published elsewhere (FM, CAV, CADE, ITP, IJCAR, AAAI, NeurIPS, ICML, etc.). Please provide a link or preprint/PDF.
(Pending copyright constraints; see note below.)
...
**If you prefer not to have your PDF posted publicly, or would like limited visibility (e.g., “participants only”), please let us know — we are happy to accommodate.**
