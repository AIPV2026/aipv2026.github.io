...
To automate this laborious process, we developed **SeLFiE**, a boolean query language to represent experienced users’ knowledge on how to apply the induct tactic in Isabelle/HOL: 
