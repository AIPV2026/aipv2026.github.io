...
filename: towards-evolutionary-theorem-proving-for-isabellehol-poster-only-paper.markdown
permalink: /projects/towards-evolutionary-theorem-proving-for-isabellehol-poster-only-paper/
---
...
Despite decades of progress in proof automation, writing mechanized proofs still requires engineers' expertise and remains labor intensive. 
Recently, researchers have extracted heuristics of interactive proof development from existing large proof corpora using supervised learning. 
...
In this abstract, we identify challenges in discovering heuristics for automatic proof search and propose our novel approach to improve heuristics of automatic proof search in Isabelle/HOL using evolutionary computation.
...
### Mindmap
[![Mindmap for TemplateBased at FSEN2023](/assets/images/mindmaps/2019_TowardsEvo_GECCO.svg)](https://drive.google.com/file/d/1ZPJh6-v_6N2LKB8Jaar7NTABZXIwyoi8/view?usp=sharing)
