...
filename: goal-oriented-conjecturing-for-isabellehol.markdown.markdown
permalink: /projects/goal-oriented-conjecturing-for-isabellehol/
---
...
- This paper won the [**best system award**](https://cicm-conference.org/2018/cicm.php?event=&menu=awards). 🥳
- Formal proceeding: [https://doi.org/10.1007/978-3-319-96812-4_19](https://doi.org/10.1007/978-3-319-96812-4_19)

### Abstract

We present **PGT**, a **Proof Goal Transformer** for Isabelle/HOL. Given a proof goal and its background context, **PGT** attempts to generate conjectures from the original goal by transforming the original proof goal. 
These conjectures should be weak enough to be provable by automation but sufficiently strong to identify and prove the original goal. 
By incorporating **PGT** into the pre-existing PSL framework, we exploit Isabelle’s strong automation to identify and prove such conjectures.
...
flowchart LR
    ...
    class GoalOriented highlighted;
...
<iframe width="560" height="315" src="https://youtube.com/embed/qph46p1W2uk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

</div>

### Mindmap
[![Mindmap for GoalOriented at CICM2018](/assets/images/mindmaps/2018_GoalOriented_CICM.svg)](https://drive.google.com/file/d/1BYWd7pvPDkpiU5hMx5Nkz5WPn9_V1s3U/view?usp=sharing)
